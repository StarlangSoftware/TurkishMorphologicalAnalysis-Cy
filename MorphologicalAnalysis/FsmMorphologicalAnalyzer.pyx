...
cdef class FsmMorphologicalAnalyzer:
    ...
    def __init__(self,
        ...
        """
        self.__most_used_patterns = {}
        self.__parsed_surface_forms = None
    ...
    cpdef set getPossibleWords(self,
        ...
        set
            set result.
        """
        cdef bint is_root_verb, contains_verb
        cdef Transition verb_transition, transition
        cdef set result
        cdef str current_word, verb_Word, plural_word
        cdef int plural_index, i
        cdef TxtWord compound_word, current_root
    ...
    cpdef bint __isPossibleSubstring(self,
                                     str shortString,
                                     str longString,
                                     TxtWord root):
        """
    ...
    cpdef __initializeParseList(self,
                                list fsmParse,
                                TxtWord root,
                                bint isProper):
        """
        ...
        """
        cdef FsmParse current_fsm_parse
        if root.isPlural():
    ...
    cpdef __initializeParseListFromRoot(self,
                                        list parseList,
                                        TxtWord root,
                                        bint isProper):
        """
    ...
    cpdef list __initializeParseListFromSurfaceForm(self,
                                                    str surfaceForm,
                                                    bint isProper):
        """
    ...
    cpdef __addNewParsesFromCurrentParse(self,
        ...
        cdef str current_surface_form, tmp, surface_form
        cdef int max_length
        cdef Transition current_transition
        cdef FsmParse new_fsm_parse
    ...
    cpdef list __parseWord(self,
        ...
        """
        cdef list result, result_transition_list
        cdef int max_length, i
        cdef FsmParse current_fsm_parse
        cdef TxtWord root
        cdef State current_state
        cdef str current_surface_form, surface_form, current_transition_list
        cdef bint exists
        result = []
    ...
    cpdef list morphologicalAnalysisRoot(self,
                                         str surfaceForm,
                                         TxtWord root,
                                         state=None):
        """
    ...
    cpdef list generateAllParses(self,
                                 TxtWord root,
                                 int maxLength):
        """
    ...
    cpdef str replaceRootWord(self,
                              FsmParse parse,
                              TxtWord newRoot):
        """
    ...
    cpdef Sentence replaceWord(self,
                               Sentence original,
                               str previousWord,
                               str newWord):
        """
        ...
        cdef list previous_word_splitted, new_word_splitted
        cdef list parse_list
        cdef TxtWord new_root_txt_word
        cdef int i, j, k
        result = Sentence()
        ...
        while i < len(parse_list):
            ...
            for j in range(parse_list[i].size()):
                if parse_list[i].getFsmParse(j).getWord().getName() == last_word and new_root_txt_word is not None:
                    replaced = True
    ...
    cpdef bint __analysisExists(self,
                                TxtWord rootWord,
                                str surfaceForm,
                                bint isProper):
        """
    ...
    cpdef bint morphologicalAnalysisExists(self,
                                           TxtWord rootWord,
                                           str surfaceForm):
        """
